...
Version  : 4.6.2
Release  : 15
URL      : https://github.com/Ultimaker/libCharon/archive/4.6.2/libCharon-4.6.2.tar.gz
Source0  : https://github.com/Ultimaker/libCharon/archive/4.6.2/libCharon-4.6.2.tar.gz
...
%prep
%setup -q -n libCharon-4.6.2
cd %{_builddir}/libCharon-4.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594748666
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libCharon-4.6.2/LICENSE %{buildroot}/usr/share/package-licenses/libCharon/2fa84abcb9ebd82e02a9ba263551d24b04e8c691
pushd clr-build
%make_install
popd
