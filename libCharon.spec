...
Version  : 4.2.0
Release  : 5
URL      : https://github.com/Ultimaker/libCharon/archive/4.2.0/libCharon-4.2.0.tar.gz
Source0  : https://github.com/Ultimaker/libCharon/archive/4.2.0/libCharon-4.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565053677
mkdir -p clr-build
pushd clr-build
