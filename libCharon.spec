...
Version  : 4.12.1
Release  : 36
URL      : https://github.com/Ultimaker/libCharon/archive/4.12.1/libCharon-4.12.1.tar.gz
Source0  : https://github.com/Ultimaker/libCharon/archive/4.12.1/libCharon-4.12.1.tar.gz
...
%prep
%setup -q -n libCharon-4.12.1
cd %{_builddir}/libCharon-4.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637697084
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libCharon-4.12.1/LICENSE %{buildroot}/usr/share/package-licenses/libCharon/2fa84abcb9ebd82e02a9ba263551d24b04e8c691
pushd clr-build
%make_install
popd
